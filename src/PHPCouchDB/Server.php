...
class Server
{
     ...
     * @param  $roles if you want to specify the roles on the server for the user. defaults to [] (optional)
     ...
     * @param  $rev      the revision of the current record (saves a query if you can specify this) (optional)
     * @param  $roles    if you want to specify the roles on the server for the user. defaults to [] (optional)
     * @return string    revision string
     * @throws \PHPCouchDB\Exception\ServerException if there's a problem
     */
